...
- **🔧 Additional Environment Variables**: Discover more environment variables in our comprehensive documentation at IMxr WebAI Documentation (https://docs.openwebui.com).
